...
- `references/supported-banks.md` — רשימת הבנקים הישראליים הנתמכים (הפועלים, לאומי, דיסקונט, מזרחי-טפחות, הבינלאומי) וחברות כרטיסי האשראי (ויזה כאל, מקס, ישראכרט, אמקס) עם קודי בנק והערות תאימות לשרת MCP. היעזרו בקובץ זה בעת הגדרת חיבורים לבנקים או פתרון בעיות חשבונות חסרים.
...
| בנק ישראל: בנקאות לציבור | https://www.boi.org.il/he/banking/general-public/ | הנחיות בנק ישראל לציבור, לוח זמנים לבנקאות פתוחה, תלונות |
